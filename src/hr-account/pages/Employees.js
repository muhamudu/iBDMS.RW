                    ...
                    <div class="pd-ltr-20 xs-pd-20-10">
                        <div class="min-height-200px">
                            <div class="page-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12 text-right">
                                        <div class="dropdown">
                                            <button class="btn btn-primary" data-toggle="modal" data-target="#AddEmployeeModal"><i class="icon-copy dw dw-add"></i> Add Employee</button>&nbsp;
                                            <button class="btn btn-primary" data-toggle="modal" data-target="#AddDepartementModal"><i class="icon-copy dw dw-add"></i> Evaluate Employee</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-box mb-30">
                                <div class="pd-20">
                                    <h4 class="text-blue h4">All Employees Recorded</h4>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                            <button class="dropdown-item"  data-toggle="modal" data-target="#EditEmployeeModal"><i class="dw dw-edit2"></i> Edit</button>
